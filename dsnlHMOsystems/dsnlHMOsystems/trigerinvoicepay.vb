...
Public Class trigerinvoicepay
    ...
    Private Sub trigerinvoicepay_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
        gstring2 = ""
    End Sub
    Private Sub trigerinvoicepay_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        My.Settings.reportsqlstr = "printinvoicerecblealert"
        Dim viewreport2 As New viewreport
        viewreport2.MdiParent = MDIParent1
        viewreport2.Text = "Print Invoice receiveable Alert"
        viewreport2.Show()
