...
Public Class company
    ...
    Public Sub InsertRecord()  'Subroutine to insert a record into the database 
        ...
        'cSQL = "INSERT INTO companytab(code1,company,email,web,picpath,Address,tel) VALUES('" & Me.code1.Text & "','" & Me.TextBox1.Text & "','" & Me.email.Text & "','" & Me.web.Text & "','" & Me.picpath.Text & "','" & Me.address.Text & "','" & Me.tel.Text & "')"
    ...
    Public Sub UpdateRecord() '****This procedures updates  CODE1,company,address,web,tel.email                       a record from the Database by using the Sql statement
        ...
        Try
            ...
            cSQL = "UPDATE companytab SET" _
                   & " company = '" & Me.TextBox1.Text & "', " & " email = '" & Me.email.Text & "', " & " web = '" & Me.web.Text & "', " & " picpath = '" & Me.picpath.Text & "', " & " Address = '" & Me.address.Text & "', " & " Address2 = '" & Me.address2.Text & "'," & " tel = '" & Me.tel.Text & "' " & " WHERE" & " code1 = '" & Me.code1.Text & "'"
