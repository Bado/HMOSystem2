...
Public Class trigpayapproval
    ...
    Private Sub trigpayapproval_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
        gstring2 = ""
    End Sub
    Private Sub trigpayapproval_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub printapprovpayalert()
        My.Settings.reportsqlstr = "printapprovpayalert"
        Dim viewreport2 As New viewreport
        viewreport2.MdiParent = MDIParent1
        viewreport2.Text = "Print Approval Pay Alert"
        viewreport2.Show()
    End Sub

   
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If reportcodee = "runpayapprovaltriger" Then
            printapprovpayalert()
        End If
    ...
    Private Sub TrigerGridView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles TrigerGridView.CellContentClick
