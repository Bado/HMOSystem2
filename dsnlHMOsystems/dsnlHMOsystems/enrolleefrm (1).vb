...
Public Class enrolleefrm
   ...
   & " rtrim(ogaid) = '" & RTrim(ogaid.Text) & "'"
    ...
    Private Sub ogaid_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ogaid.SelectedIndexChanged
        '
    End Sub
