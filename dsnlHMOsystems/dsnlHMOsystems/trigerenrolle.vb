...
Public Class trigerenrolle
    ...
    Private Sub trigpayapproval_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
        gstring2 = ""
    End Sub
    Private Sub trigerenrolle_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        My.Settings.reportsqlstr = "printenrolleealert"
        Dim viewreport2 As New viewreport
        viewreport2.MdiParent = MDIParent1
        viewreport2.Text = "Print Enrollee End dateAlert"
        viewreport2.Show()
    ...
    Sub addtomail()
        ...
        For T = T To TrigerGridView.RowCount - 1
            mailh.Text = mailh.Text + RTrim(TrigerGridView.Rows(T).Cells(3).Value) + ","
        Next
    End Sub
End Class