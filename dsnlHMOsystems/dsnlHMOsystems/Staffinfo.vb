    ...
    Sub updateimage()
        ...
        Try
            Using con As New SqlConnection(My.Settings.cnnstring)
                ...
                con.Open()
                'Dim sql As String = "INSERT INTO student VALUES(@rollno,@name,@photo)"
                Dim sql As String = "UPDATE stafftab SET childpix1 = @childpix13 where staffid = '" & staffid.Text & "'"
        ...
        Try
            Using con As New SqlConnection(My.Settings.cnnstring)
                ...
                con.Open()
                'Dim sql As String = "INSERT INTO student VALUES(@rollno,@name,@photo)"
                Dim sql As String = "UPDATE stafftab SET childpix2 = @childpix23 where staffid = '" & staffid.Text & "'"
        ...
        Try
            Using con As New SqlConnection(My.Settings.cnnstring)
                ...
                con.Open()
                'Dim sql As String = "INSERT INTO student VALUES(@rollno,@name,@photo)"
                Dim sql As String = "UPDATE stafftab SET childpix3 = @childpix33 where staffid = '" & staffid.Text & "'"
        ...
        Try
            Using con As New SqlConnection(My.Settings.cnnstring)
                ...
                con.Open()
                'Dim sql As String = "INSERT INTO student VALUES(@rollno,@name,@photo)"
                Dim sql As String = "UPDATE stafftab SET childpix4 = @childpix43 where staffid = '" & staffid.Text & "'"
