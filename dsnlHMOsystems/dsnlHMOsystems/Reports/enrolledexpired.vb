...
Public Class enrolledexpired
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.enrolledexpired.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedenrolledexpired
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As enrolledexpired = New enrolledexpired()
        rpt.Site = Me.Site
        Return rpt
    End Function
