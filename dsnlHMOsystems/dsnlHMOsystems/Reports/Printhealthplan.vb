...
Public Class Printhealthplan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.Printhealthplan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrinthealthplan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Printhealthplan = New Printhealthplan()
        rpt.Site = Me.Site
        Return rpt
    End Function
