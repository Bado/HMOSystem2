...
Public Class leavecertrpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.leavecertrpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedleavecertrpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As leavecertrpt = New leavecertrpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
