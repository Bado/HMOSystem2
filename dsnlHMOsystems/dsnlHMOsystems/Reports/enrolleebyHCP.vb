...
Public Class enrolleebyHCP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.enrolleebyHCP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedenrolleebyHCP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As enrolleebyHCP = New enrolleebyHCP()
        rpt.Site = Me.Site
        Return rpt
    End Function
