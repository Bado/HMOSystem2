...
Public Class printenrobydate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.printenrobydate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedprintenrobydate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printenrobydate = New printenrobydate()
        rpt.Site = Me.Site
        Return rpt
    End Function
