...
Public Class capitationreport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.capitationreport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcapitationreport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As capitationreport2 = New capitationreport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
