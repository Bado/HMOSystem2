...
Public Class enrolleetabdreg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.enrolleetabdreg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedenrolleetabdreg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As enrolleetabdreg = New enrolleetabdreg()
        rpt.Site = Me.Site
        Return rpt
    End Function
