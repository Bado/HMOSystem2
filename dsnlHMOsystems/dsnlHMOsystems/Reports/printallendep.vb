...
Public Class printallendep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.printallendep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedprintallendep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printallendep = New printallendep()
        rpt.Site = Me.Site
        Return rpt
    End Function
