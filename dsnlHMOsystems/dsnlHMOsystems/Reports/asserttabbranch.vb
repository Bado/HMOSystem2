...
Public Class asserttaball
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.asserttaball.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedasserttaball
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As asserttaball = New asserttaball()
        rpt.Site = Me.Site
        Return rpt
    End Function
