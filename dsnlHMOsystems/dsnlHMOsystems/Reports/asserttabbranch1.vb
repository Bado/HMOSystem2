...
Public Class asserttabbranch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.asserttabbranch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedasserttabbranch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As asserttabbranch = New asserttabbranch()
        rpt.Site = Me.Site
        Return rpt
    End Function
