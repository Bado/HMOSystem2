...
Public Class receiptbyperiod
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.receiptbyperiod.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreceiptbyperiod
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As receiptbyperiod = New receiptbyperiod()
        rpt.Site = Me.Site
        Return rpt
    End Function
