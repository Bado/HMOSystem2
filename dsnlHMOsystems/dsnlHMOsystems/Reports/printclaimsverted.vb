...
Public Class printclaimsverted
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.printclaimsverted.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedprintclaimsverted
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printclaimsverted = New printclaimsverted()
        rpt.Site = Me.Site
        Return rpt
    End Function
