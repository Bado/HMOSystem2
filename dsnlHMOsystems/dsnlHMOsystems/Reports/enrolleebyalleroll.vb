...
Public Class enrolleebyalleroll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.enrolleebyalleroll.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_oga2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedenrolleebyalleroll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As enrolleebyalleroll = New enrolleebyalleroll()
        rpt.Site = Me.Site
        Return rpt
    End Function
