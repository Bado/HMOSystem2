...
Public Class custvendtabRPTV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.custvendtabRPTV.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcustvendtabRPTV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As custvendtabRPTV = New custvendtabRPTV()
        rpt.Site = Me.Site
        Return rpt
    End Function
