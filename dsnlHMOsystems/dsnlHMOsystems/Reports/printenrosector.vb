...
Public Class printenrosector
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.printenrosector.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedprintenrosector
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printenrosector = New printenrosector()
        rpt.Site = Me.Site
        Return rpt
    End Function
