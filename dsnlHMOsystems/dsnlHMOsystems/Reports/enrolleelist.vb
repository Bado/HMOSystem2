...
Public Class enrolleelist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.enrolleelist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedenrolleelist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As enrolleelist = New enrolleelist()
        rpt.Site = Me.Site
        Return rpt
    End Function
