...
Public Class payvaluesitem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.payvaluesitem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpayvaluesitem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As payvaluesitem = New payvaluesitem()
        rpt.Site = Me.Site
        Return rpt
    End Function
