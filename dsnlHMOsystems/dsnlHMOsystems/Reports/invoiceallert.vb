...
Public Class invoiceallert
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.invoiceallert.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinvoiceallert
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoiceallert = New invoiceallert()
        rpt.Site = Me.Site
        Return rpt
    End Function
