...
Public Class enrolleetabai
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.enrolleetabai.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedenrolleetabai
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As enrolleetabai = New enrolleetabai()
        rpt.Site = Me.Site
        Return rpt
    End Function
