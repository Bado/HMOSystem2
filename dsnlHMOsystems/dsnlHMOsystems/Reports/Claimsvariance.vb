...
Public Class Claimsvariance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.Claimsvariance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedClaimsvariance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Claimsvariance = New Claimsvariance()
        rpt.Site = Me.Site
        Return rpt
    End Function
