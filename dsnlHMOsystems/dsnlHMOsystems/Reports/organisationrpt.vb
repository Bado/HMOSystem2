...
Public Class organisationrpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.organisationrpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedorganisationrpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As organisationrpt = New organisationrpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
