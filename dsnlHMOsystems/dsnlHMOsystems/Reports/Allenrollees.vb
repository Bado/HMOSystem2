...
Public Class Allenrollees
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.Allenrollees.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllenrollees
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Allenrollees = New Allenrollees()
        rpt.Site = Me.Site
        Return rpt
    End Function
