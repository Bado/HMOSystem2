...
Public Class custvendtabRPTC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.custvendtabRPTC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcustvendtabRPTC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As custvendtabRPTC = New custvendtabRPTC()
        rpt.Site = Me.Site
        Return rpt
    End Function
