        ...
        Try
            Using CCNN As New SqlConnection(My.Settings.cnnstring)
                ...
                If r.HasRows = True Then
                    r.Read()
                    'If Not r.IsDBNull(0) Then My.Settings.Rptpath = RTrim(r(0))
                    ' If Not r.IsDBNull(1) Then My.Settings.photopath = RTrim(r(1)) ,portallink
                    ' If Not r.IsDBNull(2) Then My.Settings.docfolder = RTrim(r(2))
                    '  If Not r.IsDBNull(3) Then My.Settings.imgaepath = RTrim(r(3)) 25
        ...
        Try
            Using CCNN As New SqlConnection(My.Settings.cnnstring)
                ...
                If r.HasRows Then
                    ...
                    My.Settings.companyimg = Trim(r(3))
                    My.Settings.companyid = Trim(r(4))

                    COYPICS.Image = Image.FromFile(Me.coypic2.Text)
