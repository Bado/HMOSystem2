...
Public Class enrolleebyoga2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.enrolleebyoga2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedenrolleebyoga2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As enrolleebyoga2 = New enrolleebyoga2()
        rpt.Site = Me.Site
        Return rpt
    End Function
