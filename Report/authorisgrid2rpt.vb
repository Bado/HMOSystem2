...
Public Class authorisgrid2rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.authorisgrid2rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedauthorisgrid2rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As authorisgrid2rpt = New authorisgrid2rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
