...
Public Class audittrailoption
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.audittrailoption.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedaudittrailoption
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As audittrailoption = New audittrailoption()
        rpt.Site = Me.Site
        Return rpt
    End Function
