...
Public Class Claimspayallert
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dsnlHMOsystems.Claimspayallert.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedClaimspayallert
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Claimspayallert = New Claimspayallert()
        rpt.Site = Me.Site
        Return rpt
    End Function
